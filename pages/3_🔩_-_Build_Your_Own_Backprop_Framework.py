...
""")
        st.error(r"*This should be a short, one-line function.*")
...
Also, note the use of type annotations. This is helpful when working in VSCode, because it allows you to auto-fill appropriate methods when you work with these objects.
...
""")
        st.error(r"""
*This exercise is conceptually importnant, but might be a bit difficult if it isn't clear what the question is asking for. You shouldn't spend more than ~20 minutes here.* 
""")
        st.markdown(r"""
```python
...
""")
        ...
        with st.expander(r"Help - I'm completely stuck on how to implement this, and would like the template for some code."):
            st.markdown(r"""
...
<ul class="contents">
    ...
    <li><a class="contents-el" href="#build-your-own-no-grad"><code>no_grad</code></a></li>
